...
<html>
  <head>
    ...
    <meta name = "description" content = "F140 et F160 du site (formulaire de contact)."/>
     ...
     <header>
	   ...
	   <nav>
         <ul>
		   ...
		   <li><a href="conseils-informations.php">Conseils et informations</a></li><!DOCTYPE html>
<html>
  <head>
