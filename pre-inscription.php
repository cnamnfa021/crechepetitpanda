...
<html>
  ...
  <body>
    <div id="bloc_page">
      ...
      <div id="entete">
	  <img id="imgbaniere" src="images/pre-inscription.jpg" /><!DOCTYPE html>
<html>
  <head>
    <meta charset='utf-8'/>
    <title> pre-inscription </title>
...
<!-- Création du bouton connexion qui redirige vers la page connexion-->
     ...
     <div id="mapage"> <!-- début de zone  à imprimer -->
	   <div id="introduction">
         <p> <strong> Ce document est une demande d’inscription, merci de le compléter et de le remettre à la microcrèche le plus rapidement possible : </strong> </p>
         <ul> <strong>
          <li> par email : contact@PetitPenda.fr </li>
	      <li> par courrier : Micro-crèche PetitPenda – Place INGRES– 37000 TOURS </li>
	     </strong> </ul>
